...
public class LeftRocketAutoRoutine extends AutoRoutine {
    ...
    protected List<AutoStep> createRoutine() {
        return Arrays.asList(
            ...
            new DriveStraightTrackStep(_parent, _driveController, _limelight, 46.0, 25.0, 40),
            new ElevatorMoveStep(_parent, _elevatorController, 57)
